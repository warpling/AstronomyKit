...
///
/// @param phase: The true lunar phase as 0.0, 0.25, 0.5, or 0.75 for new, first
///     quarter, full, and third quarter respectively.
...
/// @param date: The date to query.
/// @param location: The location to query.
+ (nullabel NSArray *)solarPositionHorizontalWithDate:(NSDate *)date location:(CLLocationCoordinate2D)location;
